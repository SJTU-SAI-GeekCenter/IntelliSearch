...
app = FastAPI(title="IPython Backend Server")
...
if __name__ == "__main__":
    ...
    # Override via: TOOL_BACKEND_IPYTHON_PORT
    port = config.get_with_env("tool_backend.ipython_port", 39256)
    logger.info(f"Starting IPython Backend Server on port {port}")
